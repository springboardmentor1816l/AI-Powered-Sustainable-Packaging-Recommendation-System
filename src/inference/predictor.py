"""
EcoPackAI Unified Predictor
============================

Unified inference interface for cost and CO₂ prediction models.
Handles preprocessing, prediction, and post-processing in a single interface.
